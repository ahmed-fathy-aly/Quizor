...
/**
 * The Class QuestionsEditPagerAdapter.
 */
public class QuestionsEditPagerAdapter extends FragmentPagerAdapter
{
	...
	/**
	 * Instantiates a new questions edit pager adapter.
	 *
	 * @param fm the fm
	 * @param listener the listener
	 */
	public QuestionsEditPagerAdapter(FragmentManager fm, QuestionsAdapterListener listener)
	{
		super(fm);
	...
	public Fragment getItem(int pos)
	{
		...
		return new MCQEditFragment(pos, controller);
	}
